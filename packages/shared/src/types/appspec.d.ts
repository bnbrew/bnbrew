...
export type PipelineStatus = 'PENDING' | 'PLANNING' | 'GENERATING' | 'COMPILING' | 'DEPLOYING_CONTRACTS' | 'UPLOADING_FRONTEND' | 'CONFIGURING_ACL' | 'REGISTERING_NAME' | 'VERIFYING' | 'LIVE' | 'FAILED';
